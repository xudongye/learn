...
public class HomeFlashPromotionServiceImpl implements HomeFlashPromotionService {
    ...
    private HomeFlashPromotion getFlashPromotion() {
        ...
        query.setSimpleCondition("startDate", format.format(now), QueryConstants.SimpleQueryMode.LessThan);
        query.setSimpleCondition("endDate", format.format(now), QueryConstants.SimpleQueryMode.GreaterThan);
